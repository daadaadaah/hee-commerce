...
public class OrderController {
    ...
    public ResponseDto placeOrderInAdvance(
        ...
        TokenPayload tokenPayload = authenticationService.parseAuthorization(authorization);

        UUID orderUuid = orderService.placeOrderInAdvance(orderFormDto, tokenPayload);
